...
try
    % fopen(obj1);
    obj1 = tcpclient(IP_Address, 5025);
catch exception
...
fprintf(obj1, 'CONF:FREQ (@2)');
fprintf(obj1, 'FREQ:MODE CONT');
fprintf(obj1, 'INP2:COUP DC');
if inputZ == 50 %set 53230A input Z
    fprintf(obj1, 'INP2:IMP 50');%to 50 ohm
else
    fprintf(obj1, 'INP2:IMP 1e6');%to 1M ohm
end
fprintf(obj1, '*WAI');
